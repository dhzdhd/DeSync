...
<div class="flex flex-row items-center h-12 mx-5 justify-evenly text-white gap-3">
    ...
    <!-- Message input -->
    <input bind:value={message} placeholder="Type something ..." class="flex font-normal flex-grow-[1] h-full rounded-2xl bg-dark_tertiary px-2 border-2 border-dark_accent" type="text">
    <!-- Send button -->
